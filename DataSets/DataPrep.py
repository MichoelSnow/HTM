...
# %%
TrffcFull = pd.read_csv('E:\\MyDocuments\\HTM\\TrafficData\\2016.csv', na_values="") 
TrffcFull2 = TrffcFull.drop(['Status','linkId'],axis = 1)
TrffcFull2.to_csv('E:\\MyDocuments\\HTM\\TrafficData\\2016_Sml.csv', index=False)
