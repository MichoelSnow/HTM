...
class sdr_encoder(object):
    
    def __init__(self, file_name):
        self.data_fl = self.organize_data(file_name)
        self.encoder_list = self.smart_encode(self.data_fl)
        self.encoding = self.value_encoder(self.data_fl,self.encoder_list,
                                           len(self.data_fl))



    def organize_data(self,file_name):
    ...
    def value_encoder(self,data_fl,encoder_list,enc_sz):
        encoding = []
