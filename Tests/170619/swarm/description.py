...
control = {
 ...
 u'predictionSteps': [10]},
  ...
  'metrics':[
    MetricSpec(field=u'Ct', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [10], 'errorMetric': 'aae'}),
    MetricSpec(field=u'Ct', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [10], 'errorMetric': 'altMAPE'})
  ],
