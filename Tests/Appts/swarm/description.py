...
config = {
  ...
  u'MALE':     {   'clipInput': True,
    ...
    'type': 'ScalarEncoder',
    'w': 21},
  u'AGE_0_54':     {   'clipInput': True,
    'fieldname': u'AGE_0_54',
    'maxval': 1.0,
    'minval': 0,
    'n': 100,
    'name': u'AGE_0_54',
...
control = {
  ...
  'dataset' : {   u'info': u'Ct',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'Fndng Ct',
                            u'source': u'file://appt_htm_3steps_swarm.csv'}],
        u'version': 1},
 ...
 u'predictionSteps': [3]},
  ...
  'metrics':[
    MetricSpec(field=u'Ct', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [3], 'errorMetric': 'aae'}),
    MetricSpec(field=u'Ct', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [3], 'errorMetric': 'altMAPE'})
  ],
