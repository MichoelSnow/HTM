...
permutations = {
  ...
  u'Ct': PermuteEncoder(maxval=1.0, fieldName='Ct', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  u'MARRIED': PermuteEncoder(maxval=1.0, fieldName='MARRIED', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  u'MALE': PermuteEncoder(maxval=1.0, fieldName='MALE', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  u'AGE_0_54': PermuteEncoder(maxval=1.0, fieldName='AGE_0_54', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  u'DIST_0_30': PermuteEncoder(maxval=1.0, fieldName='DIST_0_30', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[3\]:window=1000:field=Ct")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[3\]:window=1000:field=Ct"
