...
permutations = {
  ...
  u'Ct': PermuteEncoder(maxval=24000, fieldName='Ct', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(maxval=24000, classifierOnly=True, clipInput=True, minval=0, n=PermuteInt(28, 521), fieldname='Ct', w=21, type='ScalarEncoder', ),
