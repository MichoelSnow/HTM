...
# from %s_swarm_description import SWARM_DESCRIPTION
...
def swarm(filePath):
  ...
  print "================================================="
  importName =  "%s_swarm_description" % filePath[2:-4]
  print importName
  SWARM_DESCRIPTION = importlib.import_module(importName).SWARM_DESCRIPTION
