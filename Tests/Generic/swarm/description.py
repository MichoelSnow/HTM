...
config = {
  ...
  u'timestamp_weekend':     {   'fieldname': u'timestamp',
    ...
    'type': 'DateEncoder',
    'weekend': 21},
  u'EntriesDif':     {   'clipInput': True,
    'fieldname': u'EntriesDif',
    'maxval': 9097.0,
    'minval': 0.0,
    'n': 100,
    'name': u'EntriesDif',
...
control = {
  ...
  #
  'dataset' : {   u'info': u'EntriesDif',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'Fndng_H_Swarm',
                            u'source': u'file://Trnstl_103_ST_CORONA.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'EntriesDif',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'EntriesDif', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'EntriesDif', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
