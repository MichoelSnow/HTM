...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {u'timestamp_dayOfWeek': None, u'timestamp_weekend': None, u'timestamp_timeOfDay': None, u'Ct': {'maxval': 6.0, 'name': 'Ct', 'clipInput': True, 'minval': 0, 'n': 272, 'fieldname': 'Ct', 'w': 21, 'type': 'ScalarEncoder'}}}, 'spParams': {'synPermInactiveDec': 0.05015}, 'tpParams': {'minThreshold': 11, 'activationThreshold': 14, 'pamLength': 3}, 'clParams': {'alpha': 0.050050000000000004}},
