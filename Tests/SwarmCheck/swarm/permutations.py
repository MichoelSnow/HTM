...
'E:\MyDocuments\GitHub\HTM\HTMPkg\ExpGenerator.pyc'
"""
...
permutations = {
  ...
  u'timestamp_holiday': PermuteEncoder(fieldName='timestamp', encoderClass='DateEncoder.holiday', radius=PermuteChoices([1]),  w=21, ),
  u'Ct': PermuteEncoder(maxval=6.0, fieldName='Ct', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  u'Shift1': PermuteEncoder(maxval=6.0, fieldName='Shift1', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  u'Shift3': PermuteEncoder(maxval=6.0, fieldName='Shift3', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  u'Shift5': PermuteEncoder(maxval=6.0, fieldName='Shift5', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
      },
    },
